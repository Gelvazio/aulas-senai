...
C:\Python314\python.exe "..\..\scripts\gerador-materia-inteligente.py" --caminho-curso "C:\fontes\aulas-senai\sistema\RIO_DO_SUL_MAIS_TECH"
...
echo   C:\fontes\aulas-senai\sistema\RIO_DO_SUL_MAIS_TECH
echo.
