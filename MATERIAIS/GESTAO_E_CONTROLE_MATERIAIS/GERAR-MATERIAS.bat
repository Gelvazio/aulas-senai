...
cls
echo.
echo GESTAO_E_CONTROLE_MATERIAIS
echo ====================================================
...
C:\Python314\python.exe "..\..\scripts\gerador-materia-inteligente.py" --caminho-curso "C:\fontes\aulas-senai\sistema\GESTAO_E_CONTROLE_MATERIAIS"
...
echo   C:\fontes\aulas-senai\sistema\GESTAO_E_CONTROLE_MATERIAIS
echo.
