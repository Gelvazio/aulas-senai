...
cls
echo.
echo OPERADOR-PRODUCAO-INDUSTRIAL
echo ====================================================
...
C:\Python314\python.exe "..\..\scripts\gerador-materia-inteligente.py" --caminho-curso "C:\fontes\aulas-senai\sistema\OPERADOR-PRODUCAO-INDUSTRIAL"
...
echo   C:\fontes\aulas-senai\sistema\OPERADOR-PRODUCAO-INDUSTRIAL
echo.
