...
cls
echo.
echo PROGRAMADOR-DE-SISTEMAS-860-HORAS
echo ====================================================
...
C:\Python314\python.exe "..\..\scripts\gerador-materia-inteligente.py" --caminho-curso "C:\fontes\aulas-senai\sistema\PROGRAMADOR-DE-SISTEMAS-860-HORAS"
...
echo   C:\fontes\aulas-senai\sistema\PROGRAMADOR-DE-SISTEMAS-860-HORAS
echo.
