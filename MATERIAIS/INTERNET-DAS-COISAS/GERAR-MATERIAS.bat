...
C:\Python314\python.exe "..\..\scripts\gerador-materia-inteligente.py" --caminho-curso "C:\fontes\aulas-senai\sistema\INTERNET-DAS-COISAS"
...
echo   C:\fontes\aulas-senai\sistema\INTERNET-DAS-COISAS
echo.
