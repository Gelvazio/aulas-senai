...
C:\Python314\python.exe "..\..\scripts\gerador-materia-inteligente.py" --caminho-curso "C:\fontes\aulas-senai\sistema\REDES-DE-COMPUTADORES"
...
echo   C:\fontes\aulas-senai\sistema\REDES-DE-COMPUTADORES
echo.
