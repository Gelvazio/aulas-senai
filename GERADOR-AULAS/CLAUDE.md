...
## 🎓 CURSOS MONITORADOS PARA GERAÇÃO DE AULAS

Este sistema monitora e gera aulas para os seguintes cursos:

| Código | Nome do Curso | Status | Última Geração |
|--------|---|---|---|
| `GESTAO_E_CONTROLE_MATERIAIS` | Gestão e Controle de Materiais | ⏳ Em planejamento | — |
| `OPERADOR-PRODUCAO-INDUSTRIAL` | Operador de Produção Industrial | ⏳ Em planejamento | — |
| `RIO_DO_SUL_MAIS_TECH` | Rio do Sul Mais Tech | ⏳ Em planejamento | — |
| `TECNICO-INFORMATICA-INTERNET` | Técnico em Informática e Internet | ⏳ Em planejamento | — |

### Configuração de Monitoramento

**Arquivo de Referência:** `lista-cursos.json`
...
### Fluxo de Monitoramento por Curso

1. **Verificação de Ementas:** Sistema verifica se cada curso tem ementa estruturada
2. **Validação:** Ementa deve estar em formato correto (markdown ou PDF estruturado)
3. **Disparador:** Ao detectar ementa válida, sistema dispara geração automática
4. **Geração:** Cria aulas, slides, apostilas conforme regras documentadas
5. **Notificação:** Avisa responsável do curso quando aulas estão prontas
6. **Rastreamento:** Mantém log de data/hora, versão, status de revisão

### Convenção de Nomenclatura por Curso

Cada curso segue padrão de pastas:

```
C:\fontes\aulas-senai\MATERIAIS\
├── GESTAO_E_CONTROLE_MATERIAIS/
│   ├── EMENTA-*.md
│   ├── AULAS/
│   ├── MATERIAIS/
