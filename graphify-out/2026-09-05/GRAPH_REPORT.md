...
## Corpus Check
- 423 files · ~2,594,870 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8134 nodes · 8539 edges · 650 communities (633 shown, 17 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 47 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4f13dea7`
...
- 3. Conteúdo completo
- Ficha de Cadastro de Produto Customizado — Rio do Sul Mais Tech / SENAI
- Introdução à Tecnologia da Informação e Comunicação
- PLANO DE AULAS: Análise de Dados Aplicada à Gestão
- 1.2 Identificação Detalhada de Atributos
- gerar_apostila.js
- professor-senai — Regras do Projeto
- criar_apostila_ferramentas_digitais.py
- gerar_imagens.py
- RELATÓRIO DE ALINHAMENTO — Aulas vs Ementa
- /graphify
- /graphify
- Introdução à Tecnologia da Informação e Comunicação
- TEXTO DE REFORÇO — MÓDULO 3
...
- Relatório de Aulas — Introdução à Comunicação Oral e Escrita
...
- AULA 01-09-10-2026.md
- AULA 04-09-10-2026.md
- TEXTO DE REFORÇO — MÓDULO 1
- MÓDULO 3 — PROPORCIONALIDADE
- Encontro 4 — Cálculo Mental, Estimativas e Problemas Cotidianos (2h)
- AULA 06 — Segurança da Informação
- AULA 02-09-10-2026.md
- AULA 03-09-10-2026.md
- PENDENCIAS-PROFESSOR/package.json
- Verificação de Cobertura: Apostila vs. Ementa
- EMENTA: Análise de Dados Aplicada à Gestão
- gerar_atividade_simples.js
- AULA 02 — Cidadania Digital, Segurança e Impactos Sociais
- 📄 Google Docs vs Microsoft Word
- GOOGLE SLIDES vs MICROSOFT POWERPOINT
- Ementa Explicada - Introdução à Tecnologia da Informação e Comunicação
- redefinir-senha.js
- EMENTA — EXPLORAÇÃO DE CARREIRAS INDUSTRIAIS E TECNOLÓGICAS
- AULA 03 — Hardware vs Software: Diferenças Fundamentais
- MÓDULO 6 — INTRODUÇÃO À ÁLGEBRA
- ATIVIDADE AULA 10 — Avaliação Prática + Teórica
- criar_apostila_reforco_linguagens.py
- AULA 05-14-10-2026.md
- Plano de Aulas — Testes de Frontend
- AULA 16 — Scratch: Projetos Criativos Finais e Apresentação
- 📄 GOOGLE DOCS vs MICROSOFT WORD
...
- AULA 04 — Sistema Operacional: Interface, Arquivos e Pastas
- Conteúdo
- EMENTA — NOÇÕES DE ELETRICIDADE E CIRCUITOS BÁSICOS
- Encontro 13-14 — Pontuação e Seu Uso Comunicativo (4h)
- AVALIAÇÃO PRÁTICA — Introdução à Tecnologia da Informação e Comunicação
- PLANO DE AULAS — Introdução à Tecnologia da Informação e Comunicação
- AULA 07 — Software de Escritório: Editor de Textos
- ATIVIDADE AULA 03 — Testes Unitários em JavaScript (Parte 1)
- ENCONTRO 18 — Projeto Final: Pitch de Negócio
- ENCONTROS
- AULA 05 — Produtividade Digital: Editores de Texto e Processadores de Palavras
- AULA 06 — Produtividade Digital: Apresentações (Google Slides/PowerPoint)
- AULA 07 — Produtividade Digital: Planilhas Eletrônicas (Excel/Google Sheets)
- AULA 08 — Internet: Navegadores e Boas Práticas de Pesquisa
- AVALIAÇÃO FINAL — Fundamentos da Tecnologia e Programação
- Apostila_Comunicacao_15h_Versao_Joao_Revisado_2026_02.md
- 📋 ATIVIDADES MANUAIS — ENTREGA OBRIGATÓRIA
- Conteúdo
- Passos
- Encontro 18-19 — Debate e Argumentação (4h)
...
- AULA 09 — Segurança na Internet: Senhas, Vírus e Privacidade
- GOOGLE DOCS
- GOOGLE DRIVE
- GOOGLE GMAIL
- Status Geral
...
- AULA 09-15-10-2026.md
- links-turmas.js
- AULA 10 — Pensamento Computacional: Decomposição e Padrões
...
- Status Geral
- Status Geral
- AULA 06-14-10-2026.md
- AULA 08-14-10-2026.md
- Plano de Aulas — Testes de Frontend
- Status Geral
- Status Geral
- Status Geral
...
- Status Geral
- Status Geral
- 📊 VERSAO-CLAUDE — Infográficos Gerados
- Status Geral
- 📋 Tarefas Nesta Pasta
- 📋 Tarefas Nesta Pasta
- 📊 VERSAO-CLAUDE — Infográficos Gerados
- 3.1 Falar em público sem travar
- ENCONTRO 4 — Reuniões, atendimento e comunicação assertiva
- Conteúdo
- Encontro 1-2 — Tipos de Texto e Contexto de Leitura (4h)
...
- Conteúdo
- ENCONTRO 15 — Síntese, Portfólio e Preparação para Continuidade
- ENCONTRO 5 — Redação técnica: princípios e estrutura
- 📚 Conteúdo Programático
- Conteúdo
- Conteúdo
- Conteúdo
- Encontro 10-11 — Coesão Textual: Conectivos e Progressão (4h)
- EMENTA — REFORÇO MATEMÁTICA E RACIOCÍNIO LÓGICO
- AVALIAÇÃO OBJETIVA — Introdução à Tecnologia da Informação e Comunicação
- CRITÉRIOS DE CORREÇÃO — Avaliação Prática
- AULA 05 — Internet e World Wide Web: Navegação, Pesquisa, E-mail e Nuvem
...
- Apostila_Competencias_Socioemocionais_Empreendedorismo.md
- Status Geral
- Status Geral
- Conteúdo
- Conteúdo
...
- Conteúdo
- Conteúdo
- EXPLORACAO_CARREIRAS_INDUSTRIAIS_TECNOLOGICAS/gerar_slides.js
- LineForWriting
- 🟠 MICROSOFT ECOSYSTEM — Infográficos de Ferramentas Adicionais
- 🟠 MICROSOFT ECOSYSTEM — Infográficos de Ferramentas Adicionais
- ENCONTRO 10 — Aprofundamento: Redação Profissional
- ENCONTRO 1 — Comunicação no mundo do trabalho
- ENCONTRO 2 — Registro adequado e escuta ativa
- ENCONTRO 6 — Gêneros profissionais: comunicado, relato e ata
- 📚 Conteúdo Programático
- Apostila_Nocoes_Eletricidade_Circuitos_Basicos.md
- Conteúdo
- Conteúdo
- Conteúdo
- NOCOES_ELETRICIDADE_CIRCUITOS_BASICOS/gerar_slides.js
- Conteúdo
- Conteúdo
- Conteúdo
- Conteúdo
- Conteúdo
- Apostila_Reforco_Linguagens.md
- REFORCO_LINGUAGENS/gerar_slides.js
- Status Geral
- Status Geral
- Status Geral
- AULA 04 — Textos Técnicos: Relatórios, Atas, Memorandos e Resumos
...
- Status Geral
- ENCONTRO 11 — Identificando Oportunidades de Negócio
- Status Geral
- ENCONTRO 1 — O que é ser empreendedor?
- ENCONTRO 4 — Comunicação, Liderança e Trabalho em Equipe
- ENCONTRO 5 — Sustentabilidade e os 5R's
- ENCONTRO 12 — Planejamento e Estratégia Empreendedora
- compactar_atividade_ferramentas_digitais_facil.py
...
- Apostila Ferramentas Digitais para Comunicação
- Atividade fácil de Ferramentas Digitais
- Atividades de Ferramentas Digitais
- Campo Ensalado nas matérias
- Compactar atividade fácil de Ferramentas Digitais
- 🔴 COMPARATIVOS — Infográficos de Comparação
- 🔴 COMPARATIVOS — Infográficos de Comparação
- ENCONTRO 14 — Aprofundamento: Segurança Digital e Conformidade
- Excluir matérias do curso
- ENCONTRO 8 — Desafio integrador e avaliação
- ENCONTRO 9 — Aprofundamento: Atendimento ao Cliente
- Manter modal do curso ao ver aulas
- 📌 AVALIAÇÃO FINAL INTEGRADA
- 🧠 Banco de Questões de Estudo
- ENCONTRO 4 — LEI DE OHM: A EQUAÇÃO QUE EXPLICA TUDO
- ENCONTRO 14 — MOTORES, VENTILADORES E MOTO-BOMBAS
- ENCONTRO 2 — GRANDEZAS ELÉTRICAS: TENSÃO E CORRENTE
- ENCONTRO 3 — GRANDEZAS ELÉTRICAS: RESISTÊNCIA E POTÊNCIA
- ENCONTRO 5 — INSTRUMENTOS DE MEDIÇÃO
- ENCONTRO 7 — DIAGRAMAS ELÉTRICOS
- ENCONTRO 10 — TOMADAS, PLUGUES E INSTALAÇÕES PREDIAIS
- Status Geral
- ENCONTRO 13 — PROTEÇÃO ELÉTRICA: DISJUNTORES E DR
...
- EMENTA — REFORÇO DE LINGUAGENS
- AULA 03 — Comunicação Profissional: Elementos, Níveis de Fala e Trabalho em Equipe
- Remover a palavra fácil da atividade
- AULA 03 — Comunicação Profissional: Elementos, Níveis de Fala e Trabalho em Equipe
...
- ENCONTRO 7 — Agenda Ambiental (A3P) e Primavera Silenciosa
- COMPETÊNCIAS SOCIOEMOCIONAIS E EMPREENDEDORISMO
- ENCONTRO 3 — Inteligência Emocional
- ENCONTRO 17 — Virtudes do Empreendedor de Sucesso
- ENCONTRO 2 — Perfil Empreendedor e Autoconhecimento
- ENCONTRO 6 — Ciclo da Água e Legislação Ambiental
...
- 12.1 Memorando: comunicação interna eficiente
- 📌 ENCONTRO 16 — Revisão, Apresentações Finais e Reflexão
- NOÇÕES DE ELETRICIDADE E CIRCUITOS BÁSICOS
- ENCONTRO 17 — PRIMEIROS SOCORROS E PREVENÇÃO DE INCÊNDIOS
- ENCONTRO 6 — CIRCUITOS EM SÉRIE E EM PARALELO
- ENCONTRO 9 — INTERRUPTORES SIMPLES E PARALELO
...
- 4.6 Bloco 06 — Documentação e Relatórios de Teste
- 4.7 Bloco 07 — Métodos, Normas e Correção de Defeitos
- 4.8 Bloco 08 — Boas Práticas e Projeto Integrador
- 4. Autenticação
...
- criar_prova_simples_uc1_tic_equipes.py
- PARTE 2 — ROBÓTICA
- Encontro 3-4 — Tema e Ideia Principal (4h)
- Encontro 5-6 — Intenção Comunicativa e Inferências (4h)
- Encontro 8-9 — Paragrafação e Organização de Ideias (4h)
- Apostila_Reforco_Matematica_Raciocinio_Logico.md
- SLIDE-Matematica-Raciocínio-Logico — Progresso de Criação
- Conteúdo Programático
...
- Status Geral
- ENCONTRO 1 — O Que É Tecnologia? Dispositivos Digitais no Cotidiano
- Status Geral
- ENCONTRO 14 — Fluxogramas: Desenhando Soluções
- ENCONTRO 15 — Scratch: Primeiros Passos na Programação em Blocos
- ENCONTRO 16 — Scratch: Condições, Repetições e Variáveis
- ENCONTRO 17 — Scratch: Mini Projeto Final
- ENCONTRO 2 — Evolução dos Computadores e História da Tecnologia
- ENCONTRO 3 — Cidadania Digital: Fake News, Cyberbullying e Pegada Digital
- ENCONTRO 4 — Hardware e Software: O Que Tem Dentro de um Computador?
- Status Geral
- ENCONTRO 5 — Sistemas Operacionais: Windows, Linux e ChromeOS
- ENCONTRO 6 — Organização do Computador: Arquivos, Pastas e Atalhos
- Status Geral
- ENCONTRO 7 — Produtividade: Editor de Texto
- Status Geral
- Status Geral
- Status Geral
- Status Geral
- Status Geral
- ENCONTRO 8 — Apresentações Digitais (Google Slides / PowerPoint)
- ENCONTRO 9 — Planilhas Simples (Google Sheets / Excel Básico)
- ENCONTRO 10 — Internet Segura: Vírus, Senhas, Privacidade e Navegadores
- ENCONTRO 11 — Pensamento Computacional: Decomposição e Padrões
- ENCONTRO 12 — Pensamento Computacional: Abstração e Algoritmos Desplugados
...
- Ignorar arquivo ALIBABA_IA.txt
...
- Arquivos
- ATIVIDADE INTEGRADORA — UC1 Introdução à TIC
- PLANO DE AULAS — Introdução à Tecnologia da Informação e Comunicação
- Distribuição de Alunos por Desafio — PROVA SIMPLES UC1 TIC
...
- AVALIAÇÃO OBJETIVA — Introdução à Tecnologia da Informação e Comunicação
- CRITÉRIOS DE CORREÇÃO — Avaliação Prática
- 3. Unidade Curricular 1: Introdução à Tecnologia da Informação e Comunicação
- AULA 05 — Internet e World Wide Web: Navegação, Pesquisa, E-mail e Nuvem
- Análise para 3 Alunos (15 anos)
...
- 🔗 Grafo de conhecimento — SEMPRE na raiz do projeto
- 🔗 Grafo de conhecimento — SEMPRE na raiz do projeto
- 4. Unidade Curricular 2: Saúde e Segurança no Trabalho — *contexto do módulo*
...
Cohesion: 0.11
Nodes (32): ENCONTROS, bordas(), BOX(), cel(), cellP(), COD(), dimensoesPng(), doc (+24 more)

### Community 10 - "professor-senai — Regras do Projeto"
Cohesion: 0.17
Nodes (11): Commit e Push obrigatórios, Estrutura obrigatória de cada UC, Git — Execução Automática OBRIGATÓRIA, Nunca perguntar — sempre executar, Organização das provas práticas de Introdução à TIC, Organização das provas teóricas, Pasta PROFESSOR, professor-senai — Regras do Projeto (+3 more)
...
Cohesion: 0.21
Nodes (24): abrirModal(), atualizarMetricas(), avisar(), carregarContatos(), carregarUnidades(), contatos, escapar(), esconder() (+16 more)
...
Cohesion: 0.20
Nodes (10): 10. Qual recurso do Resend usar em cada caso, 11. ⚠️ LGPD e segurança, 12. Histórico de decisões, 1. Arquitetura, 2. Estrutura de arquivos, 3. Como rodar, 7. Funcionalidades do dashboard, E-MAIL-SENAI — Documentação do Projeto (+2 more)
...
Cohesion: 0.11
Nodes (18): concurrently, dependencies, concurrently, json-server, devDependencies, vite, name, private (+10 more)
...
Cohesion: 0.14
Nodes (5): token, CONFIG, STATUS_SYNC, avisar(), mostrarLinkInvalido()
...
Cohesion: 0.19
Nodes (13): args, criarUsuario(), DOMINIO, ENTRADA, escaparCsv(), EXECUTAR, gerarSenha(), lerContatos() (+5 more)
...
Cohesion: 0.39
Nodes (11): alternarAtivo(), avisar(), carregar(), copiar(), escapar(), fecharModal(), links, projetar() (+3 more)
...
Cohesion: 0.24
Nodes (10): chamarAuth(), Db, exigirLogin(), requisitar(), Sessao, sincronizarResend(), testarResend(), traduzirErro() (+2 more)

### Community 176 - "login.js"
Cohesion: 0.20
Nodes (8): Auth, abaCadastrar, abaEntrar, aviso, esconderAviso(), formCadastrar, formEntrar, trocarAba()

### Community 177 - "LineForWriting"
Cohesion: 0.24
Nodes (8): determine_lines_needed(), LineForWriting, main(), markdown_to_pdf(), Flowable, Cria linhas para os alunos escreverem respostas, Determina a quantidade de linhas necessárias conforme a pergunta, Converte Markdown para PDF com quantidade inteligente de linhas
...
### Community 196 - "Conteúdo Programático"
Cohesion: 0.12
...
Cohesion: 0.28
Nodes (6): LineForWriting, main(), markdown_to_pdf(), Flowable, Cria linhas para os alunos escreverem respostas, Converte Markdown para PDF
...
Cohesion: 0.25
Nodes (8): 1. Como rodar, 2. Primeiro acesso, 3. Estrutura, 4. Banco de dados, 5. ⬜ Passo pendente: cadastrar a chave do Resend, 6. Funcionalidades, 7. ⚠️ Atenção nos dados atuais, E-MAIL SENAI
...
Cohesion: 0.33
Nodes (6): 4. Autenticação, Fluxo de sessão (`assets/js/api.js`), Formas de criar um usuário, Redefinição de senha pela tela, 🔒 Restrição de acesso — `usuario.emailsenai`, Teste realizado em 03-09-2026
...
### Community 389 - "Conteúdo Programático"
Cohesion: 0.15
Nodes (13): 1. Para que serve uma planilha (20 min), 2. Estrutura: Linhas, Colunas, Células e Endereços (30 min), 3. Formatação de Células (30 min), 4. Fórmulas e Funções Básicas (55 min), 5. Classificação e Filtragem (30 min), 6. Tabelas, Quadros e Gráficos (35 min), 7. Configuração de Página e Impressão (20 min), A função SE em detalhe (+5 more)

### Community 390 - "6. Sincronização com o Resend"
Cohesion: 0.40
Nodes (5): 6.1 Chaves no Vault — ✅ já cadastradas, 6.2 Testar a integração, 6.3 A função `sincronizar_resend()`, 6.4 Chamada a partir do front-end, 6. Sincronização com o Resend

### Community 391 - "9. MCP do Resend (referência)"
Cohesion: 0.40
Nodes (5): 9. MCP do Resend (referência), Categorias de ferramentas disponíveis, Instalação no Claude Code, Limites relevantes, Servidor local (alternativa, via Stdio)
...
Cohesion: 0.50
Nodes (4): 5. Banco de dados, RLS, Tabela `email_contato`, Tabela `unidade` (já existia no projeto)

### Community 447 - "dependencies"
Cohesion: 0.50
Nodes (3): pptxgenjs, dependencies, pptxgenjs
...
Cohesion: 0.31
Nodes (7): listaPorId(), LISTAS_EMAIL, paraContatosResend(), paraCSV(), resumo(), separarNome(), todosOsContatos()
...
Cohesion: 0.12
Nodes (9): ClaudeGeradoAulasService, Inicializa o cliente Anthropic, Verifica se as aulas já foram geradas Args: conteudo_aulas_json: Dict com…, Extrai JSON válido de um texto que pode conter formatação markdown Args: texto:…, Gera conteúdo de slides em markdown baseado na aula Args: aula_data: dict com…, Gera conteúdo de apostila em HTML baseado na aula Args: aula_data: dict com…, Cria registro JSON para armazenar em conteudo_aulas Args: plano_aulas: dict com…, Gera plano de aulas usando Claude API Args: ementa_content: Conteúdo da ementa… (+1 more)
...
### Community 472 - "Parte I — Planejamento completo das aulas"
Cohesion: 0.14
...
### Community 505 - "AULA 02 — Sistema Operacional e Organização Digital"
Cohesion: 0.10
Nodes (20): 1. Retomada e correção da tarefa (20 min), 2. O que é um Sistema Operacional (45 min), 3. A Interface: barra de tarefas e barras de ferramentas (30 min), 4. Periféricos na prática (35 min), 5. Organização de Arquivos em Pastas (35 min), 6. Pesquisa de Arquivos e Diretórios (25 min), 7. Compactação de Arquivos (25 min), Atividade 1 (desplugada): "Arquitetos da Pasta" (30 min) (+12 more)
...
### Community 519 - "Conteúdo Programático"
Cohesion: 0.13
Nodes (15): 1. Internet × World Wide Web (30 min), 2. Navegadores (35 min), 3. Sites e Mecanismos de Busca (40 min), 4. Download e Gravação de Arquivos (25 min), 5. Correio Eletrônico (40 min), 6. Armazenamento e Compartilhamento em Nuvem (30 min), 7. Direitos Autorais e Citação de Fontes (25 min), 8. Políticas de Uso (15 min) (+7 more)

### Community 520 - "Conteúdo Programático"
Cohesion: 0.13
Nodes (15): 1. Internet × World Wide Web (30 min), 2. Navegadores (35 min), 3. Sites e Mecanismos de Busca (40 min), 4. Download e Gravação de Arquivos (25 min), 5. Correio Eletrônico (40 min), 6. Armazenamento e Compartilhamento em Nuvem (30 min), 7. Direitos Autorais e Citação de Fontes (25 min), 8. Políticas de Uso (15 min) (+7 more)
...
### Community 527 - "GeracaoSlide"
Cohesion: 0.23
Nodes (6): GeracaoSlideAdmin, GeracaoSlide, Meta, Representa um usuário autenticado via Supabase, UsuarioSupabase, register
...
Cohesion: 0.10
Nodes (19): NovoSlideForm, Formulário para criar novo slide com metadados, Tabela de slides sincronizada com Supabase, Slide, api_gerador_aulas(), deletar_geracao(), download_slide(), geracao_detalhe() (+11 more)
...
### Community 545 - "AULA 08 — Software de Escritório: Planilhas Eletrônicas"
Cohesion: 0.20
...
Cohesion: 0.12
Nodes (13): Client, logout(), Listar todos os cursos do Supabase (tabela: curso), Listar matérias (opcionalmente filtradas por curso), Upload de PPTX para storage do Supabase, Criar registro de slide na tabela, Atualizar registro de slide, Listar slides (opcionalmente filtrado por user_id) (+5 more)
...
Cohesion: 0.11
Nodes (18): Aumentar Limite de Upload, Banco de Dados, 📝 Checklist de Deploy, ⚙️ Configuração Avançada, 📚 Dependências, 📁 Estrutura do Projeto, 🔐 Fluxo de Autenticação, 🔌 Fluxo de Geração com Supabase (+10 more)
...
Cohesion: 0.25
Nodes (8): ✅ Checklist de implementação, Definição de Pendências, 📊 Estrutura da Tabela "pendencias", Fluxo Automático de Pendências, 🔄 Fluxo de Inserção de Pendências, Implementação Obrigatória, ❌ O que NÃO fazer, 🔔 Sistema de Pendências — Regra Crítica

### Community 568 - "🎯 CONTEXTO-PROJETO"
Cohesion: 0.29
Nodes (7): 📊 API Endpoints, 🚀 Como Usar, 🎯 CONTEXTO-PROJETO, 📋 Estrutura de Cursos e UCs Existentes, 🔧 Ferramentas Criadas, ⏳ Ferramentas Planejadas (Parcialmente Implementadas), ✅ Implementações Realizadas

### Community 569 - "📊 PADRÃO OBRIGATÓRIO DE INFOGRÁFICOS"
Cohesion: 0.33
Nodes (6): 🎨 CSS BASE OBRIGATÓRIO, ✅ Elementos Obrigatórios, 🎨 Estrutura Recomendada de Cores por Tema, ✅ Exemplo de Estrutura, ❌ O Que NUNCA Fazer, 📊 PADRÃO OBRIGATÓRIO DE INFOGRÁFICOS
...
### Community 581 - "AULA 07 — Software de Escritório: Editor de Textos"
Cohesion: 0.20
...
### Community 603 - "AULA 05 — Internet e World Wide Web: Navegação, Pesquisa, E-mail e Nuvem"
Cohesion: 0.20
Nodes (10): Atividade 1 (prática): "Caça à Informação Confiável" (45 min), Atividade 2 (prática): "E-mail Profissional com Anexo e Nuvem" (45 min), Atividades Práticas, AULA 05 — Internet e World Wide Web: Navegação, Pesquisa, E-mail e Nuvem, Avaliação Formativa, Estratégias de Ensino, Objetivos de Aprendizagem, Observações do Professor (+2 more)
...
Cohesion: 0.20
Nodes (10): 3. Unidade Curricular 1: Introdução à Tecnologia da Informação e Comunicação, Ambientes Pedagógicos e Recursos, Capacidades Básicas, Capacidades Socioemocionais, Carga Horária, Eixo Estruturante BNCC / Competência Integradora, Ferramentas de Ensino, Organização das provas práticas (+2 more)

### Community 607 - "AULA 05 — Internet e World Wide Web: Navegação, Pesquisa, E-mail e Nuvem"
Cohesion: 0.20
Nodes (10): Atividade 1 (prática): "Caça à Informação Confiável" (45 min), Atividade 2 (prática): "E-mail Profissional com Anexo e Nuvem" (45 min), Atividades Práticas, AULA 05 — Internet e World Wide Web: Navegação, Pesquisa, E-mail e Nuvem, Avaliação Formativa, Estratégias de Ensino, Objetivos de Aprendizagem, Observações do Professor (+2 more)
...
Cohesion: 0.33
Nodes (6): Diagrama de fluxo, 🎯 Novo Fluxo: Criar Slide com Metadados, Passo 1: Acessar novo formulário, Passo 2: Preencher formulário, Passo 3: Salvar metadados, Passo 4: Upload do PPTX (depois)

### Community 614 - "dashboard"
Cohesion: 0.33
Nodes (5): Obter informações de uso do storage, dashboard(), listar_arquivos_entrada(), Lista arquivos markdown na pasta de entrada, Dashboard principal com lista de gerações
...
Cohesion: 0.40
Nodes (5): 4. Unidade Curricular 2: Saúde e Segurança no Trabalho — *contexto do módulo*, Ambientes Pedagógicos e Recursos, Capacidades Básicas, Capacidades Socioemocionais, Eixo Estruturante BNCC / Competência Integradora

### Community 624 - "6. Configuração Supabase"
Cohesion: 0.40
Nodes (5): 6. Configuração Supabase, Controle de perfil (frontend), Estrutura `gabaritos` (coluna JSONB da tabela `curso`), Funções RPC disponíveis, Tabela `curso`
...
Cohesion: 0.25
Nodes (8): Campos Obrigatórios na Tabela `materia`, Estrutura do Campo `conteudo_aulas`, Estrutura Obrigatória da Tabela `materia`, Fluxo de Geração com Claude API, 🎓 Implementar Integração com Claude API para Geração de Aulas, Regra de Leitura - OBRIGATÓRIA, Template - Mostrar Status de Aulas, Views.py - Função para Verificar Status

### Community 645 - "Encontro 25-26 — Leitura Crítica e Análise de Discurso (4h)"
Cohesion: 0.40
...
### Community 646 - "Conteúdo Programático"
Cohesion: 0.22
...
### Community 647 - "🚀 Como Executar"
Cohesion: 0.67
Nodes (3): 🚀 Como Executar, Opção 1: Duplo Clique (Recomendado), Opção 2: Terminal

### Community 648 - "signup"
Cohesion: 0.25
Nodes (6): login(), Cadastro com Supabase, signup(), Login com email/password, Cadastro com email/password, require_http_methods
...
## Knowledge Gaps
- **5729 isolated node(s):** `token`, `contatos`, `unidades`, `PARTICULAS`, `links` (+5724 more)
