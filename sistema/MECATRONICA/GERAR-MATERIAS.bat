...
C:\Python314\python.exe "..\..\scripts\gerador-materia-inteligente.py" --caminho-curso "C:\fontes\aulas-senai\sistema\MECATRONICA"
...
echo   C:\fontes\aulas-senai\sistema\MECATRONICA
echo.
