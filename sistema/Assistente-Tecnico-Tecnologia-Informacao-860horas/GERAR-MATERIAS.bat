...
cls
echo.
echo Assistente-Tecnico-Tecnologia-Informacao-860horas
echo ====================================================
...
C:\Python314\python.exe "..\..\scripts\gerador-materia-inteligente.py" --caminho-curso "C:\fontes\aulas-senai\sistema\Assistente-Tecnico-Tecnologia-Informacao-860horas"
...
echo   C:\fontes\aulas-senai\sistema\Assistente-Tecnico-Tecnologia-Informacao-860horas
echo.
