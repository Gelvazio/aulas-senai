...
cls
echo.
echo AUTOMACAO-INDUSTRIAL-1300-HORAS
echo ====================================================
...
C:\Python314\python.exe "..\..\scripts\gerador-materia-inteligente.py" --caminho-curso "C:\fontes\aulas-senai\sistema\AUTOMACAO-INDUSTRIAL-1300-HORAS"
...
echo   C:\fontes\aulas-senai\sistema\AUTOMACAO-INDUSTRIAL-1300-HORAS
echo.
