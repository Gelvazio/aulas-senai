...
cls
echo.
echo Assistente-Processos-Gestao-Suporte-TI-860-HORAS
echo ====================================================
...
C:\Python314\python.exe "..\..\scripts\gerador-materia-inteligente.py" --caminho-curso "C:\fontes\aulas-senai\sistema\Assistente-Processos-Gestao-Suporte-TI-860-HORAS"
...
echo   C:\fontes\aulas-senai\sistema\Assistente-Processos-Gestao-Suporte-TI-860-HORAS
echo.
