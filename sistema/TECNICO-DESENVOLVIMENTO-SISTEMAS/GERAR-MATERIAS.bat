...
cls
echo.
echo TECNICO-DESENVOLVIMENTO-SISTEMAS
echo ====================================================
...
C:\Python314\python.exe "..\..\scripts\gerador-materia-inteligente.py" --caminho-curso "C:\fontes\aulas-senai\sistema\TECNICO-DESENVOLVIMENTO-SISTEMAS"
...
echo   C:\fontes\aulas-senai\sistema\TECNICO-DESENVOLVIMENTO-SISTEMAS
echo.
