...
cls
echo.
echo TECNICO-INFORMATICA-INTERNET
echo ====================================================
...
C:\Python314\python.exe "..\..\scripts\gerador-materia-inteligente.py" --caminho-curso "C:\fontes\aulas-senai\sistema\TECNICO-INFORMATICA-INTERNET"
...
echo   C:\fontes\aulas-senai\sistema\TECNICO-INFORMATICA-INTERNET
echo.
