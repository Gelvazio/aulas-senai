...
**Curso:** SENAI — Aprendizagem Industrial · Módulo Educação para o Trabalho
**Responsável:** Professor de Tecnologia (SENAI)
**Objetivo deste arquivo:** Documentar a UC, a estrutura da pasta e as regras de trabalho específicas de `sistema/INTRODUCAO_TIC/`

---

## 1. O que é esta pasta

`sistema/INTRODUCAO_TIC/` é uma **Unidade Curricular (UC)** — não é curso/contêiner.
Contém aulas, materiais, avaliações e acompanhamentos pedagógicos da UC
*Introdução à Tecnologia da Informação e Comunicação* (40h institucionais / 30h reais).
...
|---|---|
| `AULAS/` | ✅ Obrigatória — uma subpasta por aula (`AULA-NN-DD-MM-AAAA/`) com slides HTML/PDF, bancos de questões GIFT e materiais |
| `MATERIAIS/` | ✅ Obrigatória — plano de ensino, horários, códigos de acesso e apoio |
| `AVALIACOES/` | Avaliações de referência e insumos |
| `AVALIACOES_CRIADAS/` | Provas aplicadas, notas e corretores (ver `AVALIACOES_CRIADAS/CLAUDE.md`) |
| `AVALIACOES_CRIADAS/PROVA_PRATICA/` | ⚠️ Local **obrigatório** de toda prova prática desta UC |
| `AVALIACOES_CRIADAS/PROVA_TEORICA/` | Local obrigatório de toda prova teórica |
| `ACOMPANHAMENTOS_PEDAGOGICOS/` | Registros de acompanhamento pedagógico |
| `EMENTA-INTRODUCAO-TENOLOGIA-INFORMACAO.md` / `.pdf` | Ementa oficial da UC |
| `PlanoEnsinoIntroducaoTICV2.pdf` | Plano de ensino oficial |
| `MATERIAL_INTRODUCAO_TIC.html` | Material consolidado da UC |
| `CLAUDE.md` | Este documento |

⚠️ **Pendência de padrão:** falta o dashboard navegável `AULAS/index.html`, exigido por
`sistema/CLAUDE.md` para toda UC com aulas.

---

## 3. Unidade Curricular 1: Introdução à Tecnologia da Informação e Comunicação

> ⭐ **Esta é a UC desta pasta.**
...
> Total de **40 horas-aula** = 1.800 minutos = **30 horas cronológicas**.

| # | Conteúdo | Horas-Aula | Duração (min) |
|---|----------|:----------:|:-------------:|
| 1 | Comunicação em Equipes de Trabalho | 3 | 135 |
| 2 | Segurança da Informação | 5 | 225 |
| 3 | Internet (World Wide Web) | 4 | 180 |
| 4.1 | Software de Escritório — Editor de Textos | 7 | 315 |
| 4.2 | Software de Escritório — Planilhas Eletrônicas | 6 | 270 |
| 4.3 | Software de Escritório — Editor de Apresentações | 5 | 225 |
| 5 | Informática (Hardware e Sistema Operacional) | 5 | 225 |
| 6 | Textos Técnicos | 2 | 90 |
| 7 | Comunicação | 1 | 45 |
| 8 | Níveis de Fala | 1 | 45 |
| 9 | Elementos da Comunicação | 1 | 45 |
| — | **TOTAL** | **40** | **1.800** |
...
- 2.2. Reconhecer Leis vigentes à segurança da informação
...
- 4.1.10. Marcadores e numeradores
...
- 4.3.10. Recursos multimídia de apoio a apresentações e vídeos
...
- 6.3. Normas aplicáveis para redação (ex.: ABNT, ISO, IEEE, ANSI…)
- 6.4. Interpretação
...
### Eixo Estruturante BNCC / Competência Integradora
...
|------------|------|-----------------|
| Projetor Multimídia | Equipamento | Exibição de conteúdos, apresentações e vídeos para a turma |
| Computadores / PCs | Equipamento | Prática de software de escritório, internet e sistema operacional |
| Chromebook | Equipamento | Dispositivo portátil com Chrome OS para acesso a ferramentas online e Google Workspace |
| Lousa Digital | Equipamento | Interação tátil com conteúdos digitais projetados |
| Quadro Branco | Equipamento | Explanação de conceitos e diagramas durante as aulas |
| RA — Realidade Aumentada | Tecnologia | Sobreposição de elementos digitais ao ambiente real para atividades práticas |
| RV — Realidade Virtual | Tecnologia | Ambientes imersivos para simulações e experiências de aprendizagem |
| Estante Virtual SENAI DN | Recurso Didático | Repositório de materiais e livros digitais da rede SENAI |
...
> ℹ️ **Não pertence a esta pasta.** Registrada aqui apenas como contexto do Módulo
> Educação para o Trabalho. Não criar aulas/avaliações desta UC dentro de `INTRODUCAO_TIC/`.
...
- 3.2. Tipos
- 3.3. Causa
  - 3.3.1. Imprudência, imperícia e negligência
  - 3.3.2. Fator humano e pessoal na prevenção de acidentes
- 3.4. Consequências dos acidentes do trabalho (Trabalhador, família, empresa e país)
- 3.5. CAT
  - 3.5.1. Definição

#### 4. Medidas de Controle
- 4.1. Importância dos Equipamentos de Proteção Individual e coletivo

#### 5. Riscos Ocupacionais
- 5.1. Perigo e risco
- 5.2. Classificação de Riscos Ocupacionais: físico, químico, biológico, ergonômico e de acidentes
- 5.3. Mapa de Riscos

#### 6. Segurança do Trabalho
- 6.1. Histórico da Segurança do Trabalho no Brasil
- 6.2. Hierarquia das leis
- 6.3. Normas Regulamentadoras do Ministério do Trabalho
- 6.4. CIPA
  - 6.4.1. Definição
  - 6.4.2. Objetivo
- 6.5. SESMT
...
- Analisar resultado das investigações voltadas ao enfrentamento de situações cotidianas e demandas locais e coletivas para intervenções que considerem o desenvolvimento local e da comunidade
...
| Máquinas, Equipamentos, Instrumentos e Ferramentas | Computadores com acesso à internet equipados com programas de elaboração de planilhas e gráficos |
...
## 7. Como trabalhar com esta pasta

| Tarefa | Onde |
|---|---|
| Criar nova aula | `AULAS/AULA-NN-DD-MM-AAAA/` (slides HTML com **mínimo 15 slides**) |
| Criar prova prática | `AVALIACOES_CRIADAS/PROVA_PRATICA/` — nunca na raiz de `AVALIACOES_CRIADAS/` |
| Criar prova teórica | `AVALIACOES_CRIADAS/PROVA_TEORICA/` |
| Adicionar material de apoio | `MATERIAIS/` |
| Criar infográfico | Base obrigatória: `sistema/GERADOR-INFOGRAFICOS/infografico.css` |
| Planejar carga horária | Usar **30h reais**, não 40h institucionais |

---

## 8. Checklist de Conformidade

- [x] Pasta `AULAS/` existe
- [x] Pasta `MATERIAIS/` existe
- [x] Ementa oficial presente
- [x] Plano de ensino presente
- [x] `CLAUDE.md` com cabeçalho, estrutura da pasta e regras
- [x] Regra de `PROVA_PRATICA/` e `PROVA_TEORICA/` documentada
- [ ] `AULAS/index.html` (dashboard navegável da UC) — **pendente**
- [ ] Aulas em formato `.md` seguindo o template de `sistema/CLAUDE.md` — hoje só há HTML/PDF/PPTX

---

**Referências de padrão:** `CLAUDE.md` (raiz), `sistema/CLAUDE.md` (template pedagógico),
`sistema/FICHA-PRODUTO-MAIS-TECH/REFORCO_LINGUAGENS/CLAUDE.md` (modelo de CLAUDE.md de UC).
