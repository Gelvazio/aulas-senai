...
Curso **BACKEND-560-HORAS** processado com sucesso.

| Item | Valor |
|------|-------|
| Arquivo de origem | BackEnd - 570h.docx |
| Matérias criadas | 1 |
| Planos gerados | 1 |
| Aulas Markdown geradas | 5 |
| Aulas HTML geradas | 5 |
...
├── EMENTA-PRINCIPAL-BACKEND-560-HORAS.md
├── MATERIA-GERAL/
│   ├── PLANO-AULAS.md
│   ├── AULAS/
│   │   ├── AULA-01.md
