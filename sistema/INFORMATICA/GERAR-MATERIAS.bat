...
C:\Python314\python.exe "..\..\scripts\gerador-materia-inteligente.py" --caminho-curso "C:\fontes\aulas-senai\sistema\INFORMATICA"
...
echo   C:\fontes\aulas-senai\sistema\INFORMATICA
echo.
